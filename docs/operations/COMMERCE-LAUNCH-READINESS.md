...
| Worker restart and exhaustion | Durable claim leases, bounded retries and terminal exhaustion for fulfilment and communications | Guarded synthetic lease/reclaim/exhaustion rehearsal passed locally and on Render development on 21 September 2026; real worker process interruption, provider idempotency and alert ownership remain outstanding |
...
- Database interruption, real worker process-interruption recovery, provider-idempotency and provider-outage exercises. Guarded database lease/reclaim/retry-exhaustion evidence passed locally and on Render development on 21 September 2026.
