...
| Data-subject rights tabletop | Six-inject synthetic exercise covering access, rectification, erasure, restriction, marketing withdrawal, identity, processors and restore protection | `DSR-TTX-001` passed on 16 September 2026 without real data or live action. Approved ownership/retention, processor capability, operational procedure, technical restriction, restricted evidence model, secure-response delivery, isolated database deletion and restore-suppression testing remain outstanding |
...
- [x] Data-subject rights exercise `DSR-TTX-001` passed and its privacy-safe
      completion record retained. The discussion exercise does not close the
      later ownership, retention, processor, restricted-evidence,
