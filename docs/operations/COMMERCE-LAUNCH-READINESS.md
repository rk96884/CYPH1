...
| Multi-carrier and collection-point delivery | Provider-neutral delivery proposition, shipping-adapter direction and common commercial-validation pack | Preferred direction recorded: generic **Locker / Collection Point**, CYPH/1-owned carrier abstraction, Sendcloud as leading aggregator candidate and InPost/Evri as candidate underlying carriers. `docs/operations/SHIPPING-COMMERCIAL-VALIDATION.md` records comparable product-acceptance, compensation, commercial, technical and privacy questions. No integration is approved or implemented; written provider responses, final package facts and accountable approval remain outstanding. |
